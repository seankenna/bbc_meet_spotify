...
class TestSpotify:
    ...
    def test_add_albums_when_no_albums(self, mock_spotipy_client: MagicMock):
        ...
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        spotify = Spotify()
        spotify.add_albums("test-playlist-name", [])
        mock_spotipy_client_instance.query_spotify_album_tracks.assert_not_called()
    ...
    def test_add_albums_when_exception(self, mock_spotipy_client: MagicMock):
        mock_spotipy_client_instance = mock_spotipy_client.return_value
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        mock_spotipy_client_instance.query_spotify_album_tracks.side_effect = MusicNotFoundError()
        spotify = Spotify()
        album1 = Music("artist1", "title1")
        spotify.add_albums("test-playlist-name", [album1])
        mock_spotipy_client_instance.query_spotify_album_tracks.assert_called_with(album1)
        mock_spotipy_client_instance.add_music_to_playlist.assert_not_called()
    ...
    def test_add_albums(self, mock_spotipy_client: MagicMock):
        mock_spotipy_client_instance = mock_spotipy_client.return_value
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        mock_spotipy_client_instance.query_spotify_album_tracks.side_effect = [["1", "2"], ["3", "4"]]
        ...
        mock_spotipy_client_instance.query_spotify_album_tracks.assert_has_calls([call(album1), call(album2)])
        # mock_spotipy_client_instance.add_music_to_playlist.assert_has_calls([call(1, [1, 2]), call(1, [1, 2, 3, 4])])
    ...
    def test_add_songs(self, mock_spotipy_client: MagicMock):
        mock_spotipy_client_instance = mock_spotipy_client.return_value
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        mock_spotipy_client_instance.query_spotify_track.side_effect = ["1", "2", None]
        mock_spotipy_client_instance.add_music_to_playlist.side_effect = [None, None]
        spotify = Spotify()
        ...
        mock_spotipy_client_instance.query_spotify_track.assert_has_calls([call(song1), call(song2), call(song3)])
        mock_spotipy_client_instance.add_music_to_playlist.assert_called_with("1", ["1", "2"])
        assert spotify.music_not_found == []
    ...
    def test_add_songs_sanitizes_input(self, mock_spotipy_client: MagicMock):
        mock_spotipy_client_instance = mock_spotipy_client.return_value
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        mock_spotipy_client_instance.query_spotify_track.side_effect = [MusicNotFoundError(), "1"]
        spotify = Spotify()
        ...
        mock_spotipy_client_instance.query_spotify_track.assert_has_calls([call(unsanitized_music), call(sanitized_music)])
    ...
    def test_add_songs_exception(self, mock_spotipy_client: MagicMock):
        mock_spotipy_client_instance = mock_spotipy_client.return_value
        mock_spotipy_client_instance.create_playlist.return_value = "1"
        mock_spotipy_client_instance.query_spotify_track.side_effect = [MusicNotFoundError(), MusicNotFoundError()]
        spotify = Spotify()
        song1 = Music("artist1", "title1")
        spotify.add_songs("test-playlist-name", [song1])
        mock_spotipy_client_instance.query_spotify_track.assert_called_with(song1)
        mock_spotipy_client_instance.add_music_to_playlist.assert_not_called()
        assert spotify.music_not_found == ["artist1: title1"]
